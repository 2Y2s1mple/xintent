...
public class StartServiceLockedHook extends XC_MethodHook {
    ...
    // Lcom/android/server/am/ActiveServices;->startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IIZLjava/lang/String;I)Landroid/content/ComponentName;
    @Override
    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        ...
        // ComponentName startServiceLocked(IApplicationThread caller0, Intent service1, String resolvedType2,
            // int callingPid3, int callingUid4, boolean fgRequired5, String callingPackage6, int userId7)
        ...
        String log;
        if (xb == null) {
            log = String.format("startService { callingPkg=%s:%d-%d, target=%s, fgRequired=%b, retCmp=%s, intent=%s }\n",
            ...
            log = String.format("startService { callingPkg=%s:%d-%d, target=%s, fgRequired=%b, retCmp=%s, intent=%s, extras=%s}\n",
                    callingPackage,callingUid,callingPid,
                    tcmp,
                    requireForeground,
                    ret,
