...
public class GetContentProviderImplHook extends XC_MethodHook {
    ...
    // Lcom/android/server/am/ActivityManagerService;->getContentProviderImpl(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/os/IBinder;ZI)Landroid/app/ContentProviderHolder;
    @Override
    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        ...
        // ContentProviderHolder getContentProviderImpl(IApplicationThread caller0, String name1, IBinder token2, boolean stable3, int userId4)

        String name = (String) args[1];  // name here is authority
        int callingUid = Binder.getCallingUid();
        int callingPid = Binder.getCallingPid();
        String uidName = PMUtils.getPm().getNameForUid(callingUid);
