...
public class BindServiceLockedHook extends XC_MethodHook {
    ...
    // Lcom/android/server/am/ActiveServices;->bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;ILjava/lang/String;I)I
    @Override
    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        ...
        // bindServiceLocked(IApplicationThread caller0, IBinder token1, Intent service2, String resolvedType3,
            // IServiceConnection connection4, int flags5, String callingPackage6, int userId7)

        Intent intent = (Intent) args[2];
        String resolvedType3 = (String) args[3];
        int flags5 = (int) args[5];
        String callingPackage6 = (String) args[6];
        int userId7 = (int) args[7];
        ...
        String log;
        if (xb == null) {
            log = String.format("bindService { calling=%s:%d:%d, resolvedType=%s, " +
                            "flags=%d, userID=%d, target=%s, intent=%s }\n",
                    callingPackage6, uid, pid,
                    resolvedType3,
                    flags5, userId7,
                    tcmp,
                    intent.toString()
