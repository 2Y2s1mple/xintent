...
public class ZygoteSendArgsAndGetResultHook extends XC_MethodHook {
    ...
    // Landroid/os/ZygoteProcess;->zygoteSendArgsAndGetResult(Landroid/os/ZygoteProcess$ZygoteState;ILjava/util/ArrayList;)Landroid/os/Process$ProcessStartResult;
    @Override
    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
        ...
        // ProcessStartResult zygoteSendArgsAndGetResult(ZygoteState zygoteState, int zygotePolicyFlags, ArrayList arg7)
        int zygotePolicyFlags = (int) args[1];
        ArrayList zygoteArgs = (ArrayList) args[2];
        String flags = Integer.toHexString(zygotePolicyFlags);
        ...
        res = "StartProcess pid=" + pid + " flags=" + flags + " " + zygoteArgs.toString() + "\n";
